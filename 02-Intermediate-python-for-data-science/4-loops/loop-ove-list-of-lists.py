"""
Remember the house variable from the Intro to Python course? Have a look at its definition on the right. 
...
for room, area in enumerate(house):
    print("the " + str(house[room][0]) + " is " + str(house[room][1]) + " sqm")
