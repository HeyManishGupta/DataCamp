...
You'll begin by performing an inner join with the cities table on the left and the countries table on the right. Remember 
to alias the name of the city field as city and the name of the country field as country.
...
Change the code to perform a LEFT JOIN instead of an INNER JOIN. After executing this query, 
